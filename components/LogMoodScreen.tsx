...
const LogMoodScreen: React.FC<LogMoodProps> = ({ onSave, setView, editingLog, onDone, t }) => {
  ...
  return (
    <div className="flex flex-col h-full bg-white dark:bg-gray-800 text-gray-800 dark:text-gray-100">
      ...
      <div className="p-4 flex-grow overflow-y-auto no-scrollbar pb-24">
      ...
      <div className="sticky bottom-0 bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm p-4 border-t border-gray-200 dark:border-gray-700 shadow-inner" style={{ paddingBottom: 'calc(1rem + var(--safe-area-inset-bottom))' }}>
